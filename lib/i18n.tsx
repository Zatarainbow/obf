...
export const translations = {
  vi: {
    ...
    app: {
      ...
      btnObfuscate: "Bắt đầu Obfuscate",
      ...
      quickSteps: [
        ...
        { step: "3", label: "Nhấn nút Bắt đầu Obfuscate" },
      ...
      comparison: {
        tabOriginal: "Mã nguồn gốc",
        tabProtected: "Mã đã bảo vệ (Preview)",
        tabDiff: "So sánh trực quan",
        unprotectedBadge: "Chưa bảo vệ (Nguy cơ dịch ngược 100%)",
        protectedBadge: "Đã bảo vệ bởi Meowt (Chống dịch ngược 99.9%)",
        viewDiffBtn: "Xem & So sánh mã nguồn",
        copyProtectedBtn: "Sao chép mã đã bảo vệ",
        copySuccess: "Đã sao chép mã đã bảo vệ!",
        metricDecompile: "Khả năng dịch ngược",
        metricDecompileOriginal: "Dễ dàng (100% bằng decompyle++)",
        metricDecompileProtected: "Chống dịch ngược (99.9%)",
        metricFlow: "Luồng điều khiển",
        metricFlowOriginal: "Mã nguồn tuần tự hở",
        metricFlowProtected: "Làm phẳng đa nhánh (Deep Flattening)",
        metricBinary: "Lớp nhị phân",
        metricBinaryOriginal: "Không có",
        metricBinaryProtected: "WebAssembly (WASM) Engine",
        metricVm: "Môi trường thực thi",
        metricVmOriginal: "CPython Bytecode thông thường",
        metricVmProtected: "KVM 2.0 Custom Stack VM",
        metricWatermark: "Chữ ký tác giả",
        metricWatermarkOriginal: "Không có",
        metricWatermarkProtected: "Nhúng vĩnh viễn trong header",
        statusEncrypted: "Đã mã hóa thành công",
        structureTitle: "Cấu trúc gói thực thi Meowt v5.2",
        compareHeaderOriginal: "MÃ NGUỒN GỐC (CHƯA BẢO VỆ)",
        compareHeaderProtected: "MÃ ĐÃ BẢO VỆ BỞI MEOWT",
      },
      editor: {
  ...
  en: {
    ...
    app: {
      ...
      comparison: {
        tabOriginal: "Original Source",
        tabProtected: "Protected Code (Preview)",
        tabDiff: "Visual Comparison",
        unprotectedBadge: "Unprotected (100% Vulnerable to Decompilation)",
        protectedBadge: "Fortified by Meowt (99.9% Anti-Decompilation)",
        viewDiffBtn: "View & Compare Source",
        copyProtectedBtn: "Copy Protected Code",
        copySuccess: "Protected code copied to clipboard!",
        metricDecompile: "Decompilation Risk",
        metricDecompileOriginal: "High (100% decompilable via uncompyle6)",
        metricDecompileProtected: "Immune (99.9% tamper-proof)",
        metricFlow: "Control Flow Logic",
        metricFlowOriginal: "Clear sequential statements",
        metricFlowProtected: "Polymorphic Deep Flattening",
        metricBinary: "Binary Shield",
        metricBinaryOriginal: "None",
        metricBinaryProtected: "WebAssembly (WASM) Engine",
        metricVm: "Virtual Machine",
        metricVmOriginal: "Standard CPython Bytecode",
        metricVmProtected: "Proprietary KVM 2.0 Stack VM",
        metricWatermark: "Author Signature",
        metricWatermarkOriginal: "None",
        metricWatermarkProtected: "Immutable header watermark",
        statusEncrypted: "Successfully Encrypted",
        structureTitle: "Meowt Executable Bundle Structure",
        compareHeaderOriginal: "ORIGINAL CODE (UNPROTECTED)",
        compareHeaderProtected: "FORTIFIED BY MEOWT",
      },
      editor: {
